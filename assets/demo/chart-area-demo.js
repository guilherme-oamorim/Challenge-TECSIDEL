...
var myLineChart = new Chart(ctx, {
  ...
  data: {
    ...
    datasets: [{
      ...
      pointBorderColor: "rgba(12, 73, 90,1)",
      pointHoverRadius: 3,
      pointHoverBackgroundColor: "rgba(12, 73, 90,1)",
      pointHoverBorderColor: "rgba(12, 73, 90,1)",
      pointHitRadius: 10,
      pointBorderWidth: 2,
      data: [0, 1000000, 500000, 1500000, 1000000, 2000000, 1500000, 2500000, 2000000, 3000000, 3500000, 7000000],
    }],
  },
  options: {
